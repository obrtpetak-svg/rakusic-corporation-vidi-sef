                    ...
                    return (
                        <div key={s.id} style={styles.card}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                                <div><div style={{ fontSize: 15, fontWeight: 700, color: C.text }}>{s.name}</div><div className="u-fs-12" style={{ color: C.textMuted }}>{s.address && `📍 ${s.address}`}{s.city && `, ${s.city}`}</div></div>

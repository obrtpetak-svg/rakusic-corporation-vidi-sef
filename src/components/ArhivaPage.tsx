    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
                <div>
                    <div className="u-fs-24 u-fw-800" className="u-color-text">Arhiva podataka</div>
                    <div className="u-fs-12" className="u-text-muted" style={{ marginTop: 2 }}>Pregled, filtriranje i izvoz svih podataka • {projects.length} proj. • {activeWorkers.length} rad. • {timesheets.length} unosa</div>
                </div>
                ...
                <div className="u-mb-20">
                    ...
                    {section === 'projects' && (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 2fr', gap: 16, marginBottom: 16 }}>
                                {sectionStats.statusChart?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Status projekata</div><SvgDonutChart data={sectionStats.statusChart} height={160} /></div>}
                                {sectionStats.hoursPerProject?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Sati po projektu (top 10)</div><SvgBarChart data={sectionStats.hoursPerProject} dataKey="sati" height={180} /></div>}
                            </div>
                        </>
                    )}
                    ...
                    {section === 'workers' && (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 2fr', gap: 16, marginBottom: 16 }}>
                                {sectionStats.positionChart?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Po pozicijama</div><SvgDonutChart data={sectionStats.positionChart} height={160} /></div>}
                                {sectionStats.topWorkers?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Top radnici po satima</div><SvgHBarChart data={sectionStats.topWorkers} dataKey="sati" height={220} /></div>}
                            </div>
                        </>
                    )}
                    ...
                    {section === 'timesheets' && (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr 2fr', gap: 16, marginBottom: 16 }}>
                                {sectionStats.statusChart?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Status</div><SvgDonutChart data={sectionStats.statusChart} height={140} /></div>}
                                {sectionStats.typeChart?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Tip rada</div><SvgDonutChart data={sectionStats.typeChart} height={140} /></div>}
                                {sectionStats.dailyTrend?.length > 1 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Dnevni trend (zadnjih 14 dana)</div><SvgLineChart data={sectionStats.dailyTrend} dataKey="sati" height={140} /></div>}
                            </div>
                        </>
                    )}
                    ...
                    {section === 'invoices' && (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 2fr', gap: 16, marginBottom: 16 }}>
                                {sectionStats.categoryChart?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Po kategorijama</div><SvgDonutChart data={sectionStats.categoryChart} height={160} /></div>}
                                {sectionStats.topSuppliers?.length > 0 && <div style={styles.card}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Top dobavljači</div><SvgHBarChart data={sectionStats.topSuppliers} dataKey="iznos" height={200} /></div>}
                            </div>
                        </>
                    )}
                    ...
                    {section === 'vehicles' && (
                        <>
                            ...
                            {sectionStats.fuelByVehicle?.length > 0 && (
                                <div style={{ ...styles.card, marginBottom: 16 }}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Troškovi goriva po vozilu</div><SvgHBarChart data={sectionStats.fuelByVehicle} dataKey="trošak" color="#EF4444" height={180} /></div>
                            )}
                        </>
                    )}
                    ...
                    {section === 'obaveze' && (
                        <>
                            ...
                            {sectionStats.priorityChart?.length > 0 && (
                                <div style={{ ...styles.card, marginBottom: 16 }}><div className="u-section-title" className="u-fs-13 u-mb-12" className="u-mb-12" style={{ marginBottom: 10 }}>Po prioritetu</div><SvgDonutChart data={sectionStats.priorityChart} height={140} /></div>
                            )}
                        </>
                    )}
                </div>
